define(['placeholder','modalbutton','autocomplete','../util/core.js','../jquery-qrcode/jquery.qrcode.min.js',
    ...
    '../../moco/v1.0/dist/js/moco.min.js'], function() {
 ...
 Loginview = Backbone.View.extend({
        ...
        clickToFinishedRegiter: function(){
            window.location.href="https://www.imooc.com/user/setprofile"
        },
                ...
                imoocSSO.login({
                    ...
                    success:function(data){
                        ...
                        if(data.status==10001){
                            ...
                            window.location.href="https://www.imooc.com/user/userfrozen";
                            return ;
                        }
        ...
        fireLogined: function(data,signup) {
            ...
            if(signup) {
                window.location.replace("https://www.imooc.com/user/setprofile");
                return ;
            }
                    ...
                    if( res.data.caution){
                        ...
                        if( $.dialog){
                            $.dialog( str,{
                                ...
                                modal: true,
                                callback: function(){
                                    window.location.href = 'https://www.imooc.com/index/usercheck?uid=' + res.data.userInfo.uid;
                                }
                            });
                        }else{
